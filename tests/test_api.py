...
class TestAdversarialPath:
    ...
    # A real Testnet transaction hash from the e2e full test run.
    # This tx is a create_account of 100 XLM with memo "INV-TEST-184".
    REAL_TX = "dde823c73034e88525f2d1d5151f345077194e49f680c4514242fba612d95fc5"
    REAL_SENDER = "GBCIG4IAY3RLHKGIC5MB7EHMEYMJ7OZW74BCOKZO74W5Q7YBFVAWNGRG"
    REAL_RECIPIENT = "GABM2OU7AXWYMNGEW3UTZYH5XQEXXECK2IQAQZ2DH3VGJBYHQTGAUVB7"
